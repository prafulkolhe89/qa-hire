...
const clerkAppearance = {
  ...
  variables: {
    colorPrimary: "hsl(175 78% 26%)", // Matches #0F766E
  ...
  elements: {
    ...
    dividerText: "text-gray-400 text-xs uppercase font-medium tracking-wider",
    ...
    formButtonPrimary: "bg-primary hover:bg-primary/90 text-white font-medium",
    formFieldInput: "border-gray-200 rounded-md focus:border-primary focus:ring-1 focus:ring-primary outline-none",
    footerAction: "pt-6 border-t border-gray-100",
    dividerLine: "bg-gray-100",
    alert: "bg-red-50 border border-red-100 p-3 rounded-md",
...
// When the frontend and backend are on different origins (GitHub Pages + Render)
// cookies don't cross domains. This component registers a Bearer token getter
// so every API call includes "Authorization: Bearer <clerk-jwt>".
